...
def generate_fpc_property_control_report(title=None, author=None):
    cr = FPCPCR(title, author)
...
class FPCPCR:
    ...
    def _section_content(self):        
        table = [
            [
                Paragraph("ITEM", styles["rc-aawp-main-content"]),
        ...
        elems = [
            Spacer(0, -3.4 * mm),
            Paragraph("PROPERTY CONTROL REPORT", extend_style(styles["rc-header"], spaceBefore=0, spaceAfter=20)),
            Paragraph("Tag Number: {}".format(''), styles["rc-aawp-main-content"]),
            Paragraph("Case Number: {}".format(''), styles["rc-aawp-main-content"]),
            Paragraph("Recovering", styles["rc-aawp-main-content"]),
            Paragraph("Officer/Badge: {}".format(''), extend_style(styles["rc-aawp-main-content"], leftIndent=5)),
            ...
            Spacer(0, -2.2 * mm),
            Paragraph("RECEIPT INFORMATION",extend_style(styles["rc-header"])),
            Spacer(0, -2.8 * mm),
            Table(
                [
                    [
                        Paragraph("Received From: {}".format(''), styles["rc-aawp-main-content"]),
                        Paragraph("Date / Time: {}".format(''), styles["rc-aawp-main-content"]),
                    ],[
                        Paragraph("Received By: {}".format(''), styles["rc-aawp-main-content"]),
                        Paragraph("Date / Time: {}".format(''), styles["rc-aawp-main-content"]),
                    ]
                ],
                style=extend_table_style(styles["rc-main-table"], [
            ...
            Table(
                [
                    [
                        Paragraph("Released To: {}".format(''), styles["rc-aawp-main-content"]),
                        Paragraph("Date / Time: {}".format(''), styles["rc-aawp-main-content"]),
                    ],[
                        Paragraph("Destroyed By: {}".format(''), styles["rc-aawp-main-content"]),
                        Paragraph("Date / Time: {}".format(''), styles["rc-aawp-main-content"]),
                    ]
                ],
                style=extend_table_style(styles["rc-main-table"], [
            ...
            Table(
                [
                    [
                        Paragraph("Court Date: {}".format(''), styles["rc-aawp-main-content"]),
                        Paragraph("District: {}".format(''), styles["rc-aawp-main-content"]),
                    ]
                ],
                style=extend_table_style(styles["rc-main-table"], [
                ]),
