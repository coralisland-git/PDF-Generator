...
if __name__ == "__main__":
    ...
    with open(
        os.path.expanduser("~/Desktop/{}.pdf".format("probationers_right_to_counsel_english")), "wb+"
    ) as output_file:
        shutil.copyfileobj(buff_en, output_file)

    with open(
        os.path.expanduser("~/Desktop/{}.pdf".format("probationers_right_to_counsel_spanish")), "wb+"
    ) as output_file:
