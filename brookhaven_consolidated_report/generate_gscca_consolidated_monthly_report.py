...
def _create_story():
    ...
    story.append(
        Paragraph("""<b>CONSOLIDATED MONTHLY REMITTANCE REPORT – MUNICIPAL COURT</b>""",
...
def _create_footer():
    data = [
        [
            Paragraph('Effective 07/01/2017', style=text_style),
            Paragraph('Clerk of Court/Judge', style=text_style)
        ]
    ]
...
def _create_main_table():
    data = [
        ...
        [#5
            ...
            Paragraph('10% of column (3)', style=text_style),
            Paragraph('', style=text_style)
        ],
        [#6
            '', '',
        ...
        [#10
            ...
            Paragraph('<b>Crime Victims Emer. Fnd</b> (OCGA 15-21-112 for cnv of OCGA 40-6-391 (DUI of alcohol/drugs))', style=text_style),
            Paragraph('', style=text_style),
        ...
        [#16
            '', '',
            Paragraph('', style=text_style),
            Paragraph('Misdemeanors', style=text_style),
            Paragraph('', style=text_style),
        ...
        [#23
            ...
            Paragraph('<b>POPIDF-B</b> (OCGA 15-21-73 (a)(1)(B))', style=text_style),
            Paragraph('', style=text_style),
            Paragraph('Full Payments', style=text_style),
            Paragraph('', style=text_style),
            Paragraph('10% x column (3)', style=text_style),
