...
def non_jury_trial_demand_english(title=None, author=None):
...
class TDReport:
    ...
    def _section_content(self):
        ...
        elems = [
            Paragraph(
                "The above named defendant having this "+'_'*5+" day of "+'_'*11+", 201 "+'_'*4+" appeared before the Court for arraignment and entered a plea of not guilty.",
        ...
        elems += [
            ...
            Table(
                [
                    [
                        ...
                        Paragraph(
                            "I understand that I have a Constitutional right to a jury trial and I understand that by asking for a non jury trial, I am waiving my right to a jury trial.",
            ...
            Paragraph(
                "<b>I ACKNOWLEDGE my non-jury trial date is "+'_'*5+" day "+'_'*15+" of 201 "+'_'*4+" at <u>8:30 AM</u></b>",
                extend_style(styles["rc-tdwp-main"], spaceBefore=20)
            ),
            Paragraph(
            ...
            Table(
                [
                    ...
                    [
                        Paragraph("Defendant's Signature", styles["rc-tdwp-main-tb"]),
                        None,
                        None,
                ...
                colWidths=(74 * mm, 20 * mm, 16 * mm, 48 * mm, 33 * mm),
                rowHeights=2.2 * mm
            ),
            Spacer(0, 7 * mm),
            Table(
